<?php
	...
	class pedidoitens{
		...
		function pedidoitens($nome_cliente, $quantidade, $id_produto)
		{
			$this->bancoDao = new conexaoDao();
	...
	class usuario{
		...
		function usuario( $cpf, $nome, $e_mail, $nome_usuario, $senha, $root,$estado,$cidade,$bairro)
		{
			...
			if($this->verificarUsuario($nome_usuario,$e_mail,$cpf)&&$this->verificador->validaCPF($cpf)){
		...
		function verificarUsuario($nome_usuario,$e_mail,$cpf){
